...
font-family-temp:${(props) => props.family || 'IBM Plex Sans'};
...
font-family-temp: Nova Round;
font-style: normal;
font-weight: ${(props) => props.weight || 'none'};
font-size: ${(props) => props.size || '14px'};
padding:${(props) => props.padding || 'none'};
margin:${(props) => props.margin || 'none'};
background: ${(props) => props.background || '#2b325c'};
box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);
border-radius:${(props) => props.radius || '5px'}; ;
border-color:${(props) => props.background || '#2b325c'};
...
font-family-temp: IBM Plex Sans;
font-weight:bold;
color:white;
cursor:pointer;
background: ${(props) => (props.active ? '#47926E' : '#5cdfa0')};
box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);
